...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('adminlteplugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css')?>">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="index.html"><i class="fa fa-circle-o"></i> Data Buku</a></li>
            <li><a href="index2.html"><i class="fa fa-circle-o"></i> Catagory Buku</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/layout/top-nav.html"><i class="fa fa-circle-o"></i>Denda </a></li>
            <li><a href="pages/layout/boxed.html"><i class="fa fa-circle-o"></i> Peminjaman</a></li>
            <li><a href="pages/layout/fixed.html"><i class="fa fa-circle-o"></i> Pengembalian</a></li>
            <li><a href="pages/layout/collapsed-sidebar.html"><i class="fa fa-circle-o"></i> Data Pengguna</a></li>
          </ul>
        </li>
    <!-- /.sidebar -->
  </aside>
